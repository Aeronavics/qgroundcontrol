 ...
 *
 * @file
 *   @brief Custom Firmware Plugin (APM)
...
class AeronavicsCopterMode : public APMCustomMode
{
public:
    enum Mode {
...
class AeronavicsCopterFirmwarePlugin : public AeronavicsFirmwarePlugin
{
    Q_OBJECT

public:
    AeronavicsCopterFirmwarePlugin(void);
