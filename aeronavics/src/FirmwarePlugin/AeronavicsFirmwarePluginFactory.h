...
class AeronavicsFirmwarePlugin;
...
/// type of vehicle.
class AeronavicsFirmwarePluginFactory : public FirmwarePluginFactory
{
    Q_OBJECT
public:
    AeronavicsFirmwarePluginFactory();
...
private:
    AeronavicsFirmwarePlugin*   _pluginInstance;
};

extern AeronavicsFirmwarePluginFactory AeronavicsFirmwarePluginFactoryImp;
