...
Item {
    ...
    property real   _homeHeading:           _activeVehicle ? _activeVehicle.headingToHome.rawValue : 0
...
//        rightEdgeBottomInset:   parent.width - compassBackground.x
    ...
    Rectangle {
        ...
        Image {
            function homeX(homeHeading, acHeading) {
                var startAngle = 180 + acHeading
                if (startAngle < 0) startAngle += 360
                var homeAngle = homeHeading
                if (homeAngle < startAngle) homeAngle += 360
                return homeAngle - startAngle
            }
            id:                         compassHomeIndicator
            height:                     _indicatorsHeight
            width:                      height
            source:                     "/img/home.svg"
            fillMode:                   Image.PreserveAspectFit
            sourceSize.height:          height
            anchors.verticalCenter:     compassBar.verticalCenter
            anchors.topMargin:          -height / 2
            x:                          (compassBar.width / 360) * homeX(_homeHeading, _heading) - (width * 0.5)
        }
    }
    Rectangle {
        id:                         headingIndicator
    ...
    Image {
        ...
        height:                     _indicatorsHeight
        width:                      height
        source:                     "/img/compass_pointer.svg"
        fillMode:                   Image.PreserveAspectFit
        sourceSize.height:          height
