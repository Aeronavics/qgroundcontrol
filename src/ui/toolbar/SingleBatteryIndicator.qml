...
Item {
    ...
    width:          singleBatteryIndicatorRow.width
    property bool showIndicator: true

    property var _activeVehicle: QGroundControl.multiVehicleManager.activeVehicle
    property var summedBattery: _activeVehicle.summedBattery

    function getSingleBatteryColor() {
        switch (summedBattery.chargeState.rawValue) {
    ...
    function getBatteryVoltageText() {
        if (!isNaN(summedBattery.voltage.rawValue)) {
            return summedBattery.voltage.valueString + summedBattery.voltage.units
        }
        return ""
    }

    Row {
        id:             singleBatteryIndicatorRow
        anchors.top:    parent.top
        anchors.bottom: parent.bottom
                    ...
                    ColumnLayout {
                        Repeater {
                            ...
                            ColumnLayout {
                                ...
                                QGCLabel { text: object.current.valueString + " " + object.current.units }
