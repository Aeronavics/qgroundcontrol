 ...
 ****************************************************************************/
 ...
 #ifndef APMGeneratorComponent_H
 #define APMGeneratorComponent_H
 
 #include "VehicleComponent.h"
 
 class APMGeneratorComponent : public VehicleComponent
 {
    Q_OBJECT
     
 public:
    APMGeneratorComponent(Vehicle* vehicle, AutoPilotPlugin* autopilot, QObject* parent = nullptr);
