...
#ifndef APMSprayComponent_H
#define APMSprayComponent_H

#include "VehicleComponent.h"

class APMSprayComponent : public VehicleComponent
{
    Q_OBJECT
    
public:
    APMSprayComponent(Vehicle* vehicle, AutoPilotPlugin* autopilot, QObject* parent = nullptr);
